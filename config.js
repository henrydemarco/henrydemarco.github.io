var config = {
    style: 'mapbox://styles/henrydemarco/cl46hqr8a000315nrm2o2ra7e',
    ...
    chapters: [
        ...
        },
        {
            ...
            },
            {
                ...
                description2: 'Dan, who was previously unhoused himself, had been planning various sleep outs with unhoused people for years as a means of protest, community building, and respite. He was an organizer of ‘Arnieville,’ a 2010 protest against Arnold Schwarzenegger’s proposal to slash funding for in-house disability services. Arnieville would go on for a month, making it one of the longest-lasting disability rights protests in US history, according to <a href="https://thestreetspirit.org/2010/08/01/the-message-of-arnieville-lives-on/" target="_blank" style="color: blue">Street Spirit</a>. He founded the Disabled People Outside Project to address these kinds of injustices –– he runs the project to this day. For years, he stockpiled tents, stoves, and other equipment necessary for outdoor living, which he planned to use to support a longer, more mobile sleep-out. What he saw at the Hub left him angry, and gave him the extra push he needed to work towards a vision he’d been brewing for years.',
                location: {
            ...
            },
            {
                ...
                image: '',
                audio: '',
                description: 'From 1910-1970, approximately six million Black people moved out of the American South to the north, midwest, and west, to pursue educational and economic opportunities and to escape from the mounting violence of Jim Crow. The Great Migration is one of the largest movements of any group in American history, and can be understood in two waves. The First Great Migration (1910-1940) was a relocation to the north and midwest; as industrial jobs were left vacant during the first world war, Black populations joined the non-agricultural labor force. Although migrants moved to escape from racial violence, they were met with similar racism in their new communities, from white people who were furious with the changing demographics. In the Second Great Migration (1940-1970), people moved further north, but also west. Black people who migrated after World War II were met with organized pushback from the white localities, who were implementing discriminatory and segregationist practices.',
                location: {
                    center: [-122.27125, 37.8488],
                    zoom: 13,
                    pitch: 60,
            ...
            },
            {
                ...
                description2: 'Current camp resident Atlas has taken a humane position on the disposal of rats, trapping them alive and releasing them far from camp (when possible). But even he admits that the gestation period of the species poses a constant threat to the wellbeing of the camp. Campers are in agreement: the city waits for rat infestations to overtake camps, because rats are a commonly cited reason for eviction. The city does not provide rat traps or fly strips for the camp –– camp members have innovated and adapted to keep vermin at bay.',
                location: {
                    center: [-122.27142, 37.84738],
                    zoom: 17,
                    pitch: 0,
            ...
            },
            {
                ...
                description: '“It was so integral to bringing me back from the environmental pounding that ruined me,” says Sam. "And it does that for a lot of people, I’m not unique on that. It takes people that have been pounded and pounded and pounded by the urban environment, and it stabilizes them enough to get them to the next step. Not everyone’s next step is the same next step, but I’m telling you, the vast majority of people that come out of that camp, the next step is a much more positive step. It’s the next positive step –– it’s not just an encampment on the side of the road.” <br><br><a href="#directory">Back to Table of Contents</a>',
                location: {
                    center: [-122.27136, 37.84788],
                    zoom: 16,
                    pitch: 65,
